...
Examples:
  ...
  zone-poker example.com --records --types A,MX,TXT
    ...
    output_group.add_argument(
        ...
        help="Template for report filenames. Use {domain} and {timestamp}. Default: '{domain}_dnsint_{timestamp}'.",
    )
    output_group.add_argument(
    ...
    output_group.add_argument(
        ...
        "--quiet",
        action="store_true",
        help="Show minimal console output (suppresses tables and headers). This does not affect file-based exports.",
    )
    output_group.add_argument(
        "--output",
