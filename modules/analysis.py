...
import httpx  # CHANGED: Replaced 'requests' with 'httpx' for async support
...
def email_security_analysis(domain: str, records: Dict[str, List[Dict[str, Any]]]) -> Dict[str, Any]:
    ...
    # Some configs put DMARC on the root domain, which is incorrect
    if not dmarc_records:
         try:
            # We must use a sync call here or refactor to pass a resolver
            resolver = dns.resolver.Resolver()
