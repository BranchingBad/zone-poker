...
async def test_subdomain_takeover_found():
    """Test that a potential subdomain takeover is correctly identified."""  # noqa
...
async def test_subdomain_takeover_not_found():
    """Test that no takeover is reported when CNAME matches but fingerprint does not."""  # noqa
...
async def test_subdomain_takeover_no_cnames():
    """Test that the function returns empty results when no CNAME records are provided."""  # noqa
...
async def test_subdomain_takeover_network_error():
    """Test that a network error during the HTTP check is handled gracefully."""  # noqa
...
async def test_subdomain_takeover_missing_keys():
    """Test that CNAME records missing 'name' or 'value' keys are handled gracefully."""  # noqa
    records = {
        "CNAME": [
...
async def test_fingerprint_caching():
    """Test that the fingerprint JSON file is only read once due to lru_cache."""  # noqa
...
def test_fingerprints_file_is_packaged():
    """Tests that the takeover_fingerprints.json file is correctly included in the package data."""  # noqa
