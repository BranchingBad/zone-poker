...
def mock_secure_data():
    ...
    return {
        ...
        "ssl_info": {"valid_until": future_timestamp, "cipher": ("TLS_AES_256_GCM_SHA384", "TLSv1.3", 256)},
        "takeover_info": {"vulnerable": []},
        "dnsbl_info": {"listed_ips": []},
        "port_scan_info": {},
        "reputation_info": {
            "1.2.3.4": {"abuseConfidenceScore": 10}
        }
    }
...
def mock_weak_data():
    ...
    return {
        ...
        "reputation_info": {
            "1.2.3.4": {"abuseConfidenceScore": 95}
        }
    }
...
def mock_moderate_data(mock_secure_data):
    ...
    mock_secure_data["headers_info"]["analysis"]["Strict-Transport-Security"] = {"status": "Weak"}
